...
function CourseSection() {
  ...
  return (
    <div>
      <div className='flex flex-col items-center mt-8 sm:mt-10 lg:mt-0 gap-2 sm:gap-4 lg:gap-2 px-8 sm:px-10 lg:px-12 xl:px-20' data-aos="fade-up">
        <HeadingMenu heading={"Courses"}/>
        <Tagline tagline={"Embark on a transformative learning journey with our comprehensive range of courses. Designed to empower individuals with the knowledge and skills needed to succeed in todays dynamic world, our courses cover a diverse array of subjects and disciplines."}/>
      ...
      <div className='flex items-center justify-center flex-col pt-[180px] sm:pt-[250px] lg:pt-[350px] xl:pt-[400px] mb-[200px] lg:mb-[100px] relative' >
        <Image src={Bglines} alt='random' width={500} height={500} className='w-[300px] sm:w-[600px] lg:w-[850px] xl:w-[1050px] h-auto'/>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={1} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={2} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={3} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={4} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={5} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={6} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={7} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={8} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={9} des={"Role of UI/UX in Product Development"}/>
          </div>
          ...
          <CardCourse title={"Introduction to UI/UX Design"} no={10} des={"Role of UI/UX in Product Development"}/>
          </div>
