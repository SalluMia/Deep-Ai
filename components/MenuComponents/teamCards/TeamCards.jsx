      ...
      {List.map((value, index) => {
        return (
          ...
          >
            ...
            <div
              className=" h-[400px] w-[65%] flex flex-col justify-center gap-2"
              data-aos="fade-up"
            >
              <h1 className="font-varino text-[16px] sm:text-[20px] lg:[22px] xl:text-[24px]">
                Description
              </h1>
