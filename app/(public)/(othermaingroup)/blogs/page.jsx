...
import BlogMainImage from "@/public/images/blog/blogMain.png";
      ...
      <div className="flex flex-col items-center gap-7 sm:gap-10 lg:gap-12 px-8 sm:px-10 lg:px-12 xl:px-20">
        <div className="flex flex-col gap-3" data-aos="fade-up">
          ...
          <p className="font-monosans text-[14px] sm:text-[16px] xl:text-[18px] text-center text-white sm:px-20 lg:px-32 xl:px-40">
            Our Blogs and News section is your gateway to staying informed and
            inspired. Dive into a treasure trove of insightful articles,
            thought-provoking essays, and up-to-the-minute news updates curated
            by our team of experts. Whether you are seeking industry trends,
            practical advice, or the latest happenings, our platform offers a
            diverse range of content to suit your interests.
          </p>
        </div>
        <Image
          src={BlogMainImage}
