...
function GenerativeAI() {
  let data = {
    ...
    description:
      "Experience the future with our pioneering Generative AI technologies, designed to streamline your company operations. Custom artificial intelligence solutions that make use of your one-of-a-kind data to improve productivity and simplify operations are our forte here at Alright Tech. To guarantee increased productivity without the hassle of migration, our team of talented engineers is an expert at smoothly integrating the latest technologies into your company framework. These models include ChatGPT, DALL-E, and MidJourney. Our Generative AI services may change and adapt to meet your changing requirements, whether that's automating complicated processes or improving data-driven initiatives. Take the lead in innovation by empowering your organization with Alright Tech.",
    img: GenAI,
    serviceDesc:
